			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nslists-display": {
								"semanticObject": "nslists",
								"action": "display",
								"description": "Types of list",
								"title": "Lists",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.lists",
									"url": sap.ui.require.toUrl("ns/lists")
								}
							}
						}
					}
